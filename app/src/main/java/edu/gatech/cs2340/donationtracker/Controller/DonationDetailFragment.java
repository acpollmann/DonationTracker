...
/**
 * A fragment representing a single Donation detail screen.
 */
public class DonationDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_DONATION_ID)) {
            ...
            Log.d("CourseDetailFragment", "Got donations: " + mDonation.getName());

            Activity activity = this.getActivity();

            ScrollView appBarLayout = (ScrollView) activity.findViewById(R.id.donation_scroll_view);
            if (appBarLayout != null) {
                appBarLayout.addView(mDonation.toString());
            }
        }
